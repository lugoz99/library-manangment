...
using LibraryManagment.Models.Dtos.Categories; // Asegúrate de que tus DTOs de SubCategoría estén aquí o ajusta el namespace
using LibraryManagment.Services.Contracts;     // Es mejor buena práctica usar la Interfaz (ISubCategoryService) si la tienes
